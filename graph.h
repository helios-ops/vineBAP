...
protected:
	...
	if (inserted) {
	    /* edge_map     : boost-edge        -> user-defined edge
	     * edge_rev_map : user-defined edge -> boost-edge  
	     */
	    edge_map[ed] = e;
	    edge_rev_map[e] = ed;
	}
